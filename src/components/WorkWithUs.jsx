    ...
    <section className="my-container">
      <div className="bg-[#F3F1FF] rounded-xl lg:rounded-3xl p-5 lg:p-10">
        <div className="flex justify-between gap-10">
          <div className="mr-20">
            <h2 className="text-lg md:text-3xl lg:text-4xl tracking-wide font-semibold lg:font-bold pb-6 lg:pb-10">Work with us</h2>
            <div className="bg-white p-5 lg:p-8 card space-y-2 lg:space-y-3">
              ...
              <p className="font-medium text-gray-600 leading-7">At ahead our goal is to make self- improvement fun and lasting. We know there&apos;s a way how to make it work. And that&apos;s what aHead is all about!</p>
            </div>
            <div className="bg-[#FEF7F1] p-5 lg:p-8 card space-y-2 lg:space-y-3 -top-6">
              <h5 className="text-lg lg:text-xl font-semibold lg:font-bold tracking-wide">Product</h5>
              <p className="font-medium text-gray-600 leading-7">Sure, you could spend ages reading books or sitting in seminars on how to become a better spouse, parent, or manager - like we did...</p>
            </div>
          </div>
          <div>
            <h2 className="text-lg md:text-3xl lg:text-4xl tracking-wide font-semibold lg:font-bold primary-color pb-6 lg:pb-10">ahead</h2>
            <div className="bg-white p-5 lg:p-8 card space-y-2 lg:space-y-3">
          ...
          <div className="bg-white w-2 relative mt-8 lg:mt-20">
