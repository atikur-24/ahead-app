      ...
      <div className="bg-[#F3F1FF] rounded-xl lg:rounded-3xl p-5 lg:p-10">
        <div className="lg:flex justify-between gap-10 space-y-2 lg:space-y-0">
          <div className="lg:mr-20">
            <h2 className="text-lg md:text-3xl lg:text-4xl tracking-wide font-semibold lg:font-bold pb-6 lg:pb-10 text-center lg:text-left">Work with us</h2>
            <div data-aos="fade-right" className="bg-white p-5 lg:p-8 card space-y-2 lg:space-y-3">
            ...
            <div data-aos="fade-right" className="bg-[#FEF7F1] p-5 lg:p-8 card space-y-2 lg:space-y-3 -top-3 lg:-top-6">
          ...
          <div>
            ...
            <div data-aos="fade-left" className="bg-white p-5 lg:p-8 card space-y-2 lg:space-y-3">
            ...
            <div data-aos="fade-left" className="bg-white p-5 lg:p-8 card space-y-2 lg:space-y-3 my-5 lg:my-8">
