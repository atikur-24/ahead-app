...
const Banner = () => {
  return (
    <section className="my-container">
      ...
      <div className="absolute lg:top-1/2 top-1/4 ml-5 md:ml-8 lg:ml-12 w-1/2 space-y-2 lg:space-y-4">
        <p className="text-sm lg:text-base tracking-wide font-medium">Ahead app</p>
        <h1 className="text-xl lg:text-6xl font-bold lg:font-extrabold tracking-wide lg:tracking-wider">
          Master your life <br /> by mastering <br /> emotions
        </h1>
        <div className="lg:flex gap-3 lg:gap-6 pt-2 lg:pt-6">
