  ...
  return (
    <section className="my-container">
      <div className="px-10 lg:px-16">
        <h2 className="text-lg md:text-3xl lg:text-4xl tracking-wide font-semibold lg:font-bold pb-4 lg:pb-8">Open vacancies</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-[#FEFBEC] p-3 lg:p-5 space-x-1 lg:space-y-2 card rounded-lg">
