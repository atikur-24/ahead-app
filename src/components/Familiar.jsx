  ...
  return (
    <section className="lg:pb-5 xl:lg:pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mx-6 lg:-mx-40">
        <div data-aos="fade-up-right" className="bg-[#D8F2FF] rounded-md lg:rounded-xl p-5 lg:p-7 space-y-2 lg:space-y-4">
        ...
        <div data-aos="fade-up-right" className="bg-[#EEEBFE] rounded-md lg:rounded-xl p-5 lg:p-7 space-y-2 lg:space-y-4">
          <h4 className="text-xl lg:text-2xl">😠</h4>
          <h3 className="text-lg lg:text-xl whitespace-nowrap font-medium lg:font-semibold">You argue with a colleague</h3>
          <p className="leading-6 lg:leading-7 text-xs lg:text-sm">You get angry and defensive, instead of staying open and working towards common ground.</p>
        </div>
        <div data-aos="fade-up-left" className="bg-[#6341EF] text-white rounded-md lg:rounded-xl p-5 lg:p-7 space-y-2 lg:space-y-4 lg:-rotate-6">
          <h4 className="text-xl lg:text-2xl">😲</h4>
        ...
        <div data-aos="fade-up-left" className="bg-[#FFEFD5] rounded-md lg:rounded-xl p-5 lg:p-7 space-y-2 lg:space-y-4">
          <h4 className="text-xl lg:text-2xl">🤨</h4>
